...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.JobInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
            ...
            modelBuilder.Entity("Core.Entities.JobPortal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
            ...
            modelBuilder.Entity("Core.Entities.JobUrl", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
            ...
            modelBuilder.Entity("Core.Entities.JobInfo", b =>
                {
                    b.HasOne("Core.Entities.JobUrl", "JobUrl")
                        .WithOne("JobInfo")
                        .HasForeignKey("Core.Entities.JobInfo", "JobUrlId")
            ...
            modelBuilder.Entity("Core.Entities.JobUrl", b =>
                {
                    b.HasOne("Core.Entities.JobPortal", "JobPortal")
                        .WithMany("JobUrls")
                        .HasForeignKey("JobInfoId");

                    b.HasOne("Core.Entities.Salary", "Salary")
                        .WithOne("JobUrl")
                        .HasForeignKey("Core.Entities.JobUrl", "SalaryId");
                });

            modelBuilder.Entity("Core.Entities.Tag", b =>
                {
                    b.HasOne("Core.Entities.JobInfo", "JobInfo")
                        .WithMany("Tags")
                        .HasForeignKey("JobInfoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Entities.TagCategory", "TagCategory")
                        .WithMany("Tags")
